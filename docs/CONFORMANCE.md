...
| Name7-B (SHOULD) — industry-standard extensions | `/req/core/name-extensions-B` | `NamingWarning::NonSpecExtension`, `ApplicationProfile::known_extensions` | `req_core_name_extensions_unknown_extension_warns`, `req_core_name_extensions_simulation_vouches_for_wkt` |
